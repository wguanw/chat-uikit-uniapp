    ...
    <view v-for="(item, index) in conversationList" :key="index">
      ...
      >
        ...
        <main class="content">
          ...
          <footer class="content-footer">
            ...
            <span class="message-text">{{
              handleItemMessage(item.lastMessage)
            }}</span>
            <view class="conversation-line"></view>
          </footer>
          <view class="item-footer">
            <span class="time">{{
              handleItemTime(item.lastMessage.lastTime)
            }}</span>
            <image
              class="mute-icon"
        ...
        <view
          ...
          v-if="item.conversationID === dialogID"
        >
          <view
            class="conversation-options"
            @click.stop="handleConversation('delete', dialogID)"
            >删除会话</view
          >
          <view
            class="conversation-options"
            v-if="!item.isPinned"
            @tap.stop="handleConversation('ispinned', dialogID)"
            >置顶会话</view
          >
          <view
            class="conversation-options"
            v-if="item.isPinned"
            @click.stop="handleConversation('dispinned', dialogID)"
            >取消置顶</view
          >
          <view
            class="conversation-options"
            ...
            "
            @click.stop="handleConversation('mute', dialogID)"
            >消息免打扰</view
          >
          <view
            class="conversation-options"
            v-if="item.messageRemindType === 'AcceptNotNotify'"
            @click.stop="handleConversation('notMute', dialogID)"
            >取消免打扰</view
          >
        </view>
      </view>
